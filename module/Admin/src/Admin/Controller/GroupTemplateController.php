...
class GroupTemplateController extends MainController
{
    public function __construct()
    {
        $this->moduleName   = 'Nhóm giao diện';
        $this->module       = 'group-template';
        $this->modelClass   = 'Application\Model\GroupTemplate';
        $this->status       = ['1' => 'Kích hoạt', '0' => 'Tạm dừng'];
        $this->formClass    = '\Admin\Form\GroupTemplate';
    }
